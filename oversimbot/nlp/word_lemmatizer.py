...
class WordLemmatizer:
    def __init__(self):
        self.ending_list = self.load_endings().split()
    ...
    def find_word_core(self, word):
        ...
        for ending in self.ending_list:
            if(word.endswith(ending)):
                ...
                base_form = re.sub(ending+'$', '', word)
                break
        return base_form

    def find_word_core_list(self, text_list):
        rtn_dict = {}
    ...
    def load_endings(self):
        return GLOBAL_WORD_ENDINGS

GLOBAL_WORD_ENDINGS = """tumeisi
tumėmės
tumėtės
iuosna
tumėme
